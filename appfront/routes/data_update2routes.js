...
router.get('/data_update2', function (req, res) {
    ...
    console.log("data_update2 is coming");
    ...
    var txt = "dat3|" + str1 + "|" + str2 + "|" + urlname + "|" + str3 + "|" + urln + "|" + id;
    txt = aesEncrypt(txt);
    //str1 + "|" + str2 + urlname + str3 + urln + "|id=" + id;
