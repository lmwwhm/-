...
router.get('/book', function (req, res) {
    ...
    if (name == "no input") var txt = "bo51|" + str2 + "|" + str1;
    //"id,name,plan," + str2 + "|" + str1 + "|id >= 0||||B";
    else var txt = "bo52|" + str2 + "|" + str1 + "|" + urlname;
    txt = aesEncrypt(txt);
    //"id,name,plan," + str2 + "|" + str1 + "|name =" + urlname + "||||B";
