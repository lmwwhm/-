...
router.get('/data_add', function (req, res) {
    ...
    var txt = "dat1|" + str1 + "|" + str2 + "|" + str3 + "|" + str4 + "|" + urlname + "|" + urln + "|" + urlq;
    txt = aesEncrypt(txt);
    //str1 + "|(" + str2 + str3 + str4 + ")|(" + urlname + urln + urlq + ")|A";
