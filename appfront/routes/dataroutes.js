...
router.get('/data', function (req, res) {
    ...
    if (name == "no input") var txt = "dat7|" + str2 + "|" + str3 + "|" + str4 + "|" + str1;
    //"id," + str2 + str3 + str4 + "|" + str1 + "|id >= 0||||B";
    else var txt = "dat8|" + str2 + "|" + str3 + "|" + str4 + "|" + str1 + "|" + urlname;
    txt = aesEncrypt(txt);
    //"id," + str2 + str3 + str4 + "|" + str1 + "|'文件名' =" + urlname + "||||B";
