...
router.get('/role_add', function (req, res) {
    ...
    console.log("role_add is coming");
    ...
    var txt = "ro1|" + str1 + "|" + str2 + "|" + str3 + "|" + str4 + "|" + str5 + "|" + urlname + "|" + urlage + "|" + urlusername + "|" + urlpassword + "|" + urlphone + "|" + urlq;
    txt = aesEncrypt(txt);
