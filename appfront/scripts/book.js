function cook(x) {
    ...
    var plan = x.cells[3].innerText;
    var zt = x.cells[4].innerText;
    ...
    xmlHttp.onreadystatechange = function () {
        if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                var td = document.createElement('td'); //新建td
                td.innerHTML = "<td><a style='text-decoration:none' onclick='book_finish(this)' title='完成' ><i class='layui-icon'>&#xe601;</i></a><a title='编辑' onclick='cook(this.parentNode.parentNode);xadmin.open(\"修改读书计划\", \"./book_update.html\", 800, 340)'><i class='layui-icon'>&#xe642;</i></a><a title='删除' onclick='book_del(this)' style='text-decoration:none'><i class='layui-icon'>&#xe640;</i></a></td>";
                tr.appendChild(td);
            }
        }
